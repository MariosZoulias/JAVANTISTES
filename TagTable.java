...
public class TagTable {
	...
	public static void main(String[] argv) throws Exception {
		...
		String tag = "<table> " + "<caption>This is the caption</caption>"
		+ "<tr> "
		+ "<td>gr1-kel1</td>" + " <td>gr1-kel2</td>" + " <td>gr1-kel3</td>" 
		+ "</tr>" + "<tr>" + "<td>gr2-kel1</td>" + "<td>gr2-kel2</td>"
		+ "</tr></table>";
		...
		if (epikefalida != null) {
			panel.setBorder(BorderFactory.createTitledBorder(
					BorderFactory.createEtchedBorder(), epikefalida,
